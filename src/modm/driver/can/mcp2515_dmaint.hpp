...
#define MODM_MCP2515_DMAINT_HPP
...
private:
	...
	inline static uint8_t statusBufferReady = 0;
	inline static uint8_t addressBufferR = 0;
	inline static uint8_t addressBufferS = 0;
	inline static uint8_t i, j = 0;
	inline static uint8_t a = 0;
	inline static uint8_t b = 0;
	inline static uint8_t data = 0;
	inline static bool readSuccessfulFlag = false;
	inline static bool readIdentifierSuccessfulFlag = false;
	inline static bool isReadyToSendFlag = false;
	inline static bool receiveSuccess = false;

	inline static uint8_t recv_prep_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
	inline static uint8_t recv_tx_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
	inline static uint8_t recv_rx_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
	inline static uint8_t send_prep_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
	inline static uint8_t send_tx_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
	inline static uint8_t send_rx_buf[modm::mcp2515::options::SPI_BUFFER_SIZE];
...
#include "mcp2515_dmaint_impl.hpp"

#endif  // MODM_MCP2515_DMAINT_HPP
